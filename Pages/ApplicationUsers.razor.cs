...
namespace CleverCRM.Pages
{
    public partial class ApplicationUsers : ComponentBase
    {
        ...
        protected IEnumerable<CleverCRM.Models.ApplicationUser> users;
        protected RadzenDataGrid<CleverCRM.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(CleverCRM.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(CleverCRM.Models.ApplicationUser user)
        {
            try
            {
